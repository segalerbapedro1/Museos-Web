    ...
    images: [
      {
        ...
        motivos: ["mapa", "objetos", "ruido", "diurnas"],
        emociones: ["tensión"],
      },
      {
        ...
        anio: 1998,
        tecnica: ["fotografía"],
        motivos: ["rostro", "dualidad", "cuerpos", "ruido", "diurnas"],
        emociones: ["tensión"],
      },
      {
  ...
  malba: {
    ...
    images: [
      { file: "03-berni-manifestacion.jpg", alt: "Manifestación, de Antonio Berni, colección MALBA", title: "Antonio Berni, Manifestación",
        autor: "Antonio Berni", anio: 1934, tecnica: ["pintura"], motivos: ["cuerpos", "multitud", "rostro", "ruido", "diurnas"], emociones: ["tensión", "tristeza"]},
      { file: "01-doamoral-Abaporu.jpg", alt: "Abaporu, de Tarsila do Amaral, colección MALBA", title: "Tarsila do Amaral, Abaporu",
        autor: "Tarsila do Amaral", anio: 1928, tecnica: ["pintura"], motivos: ["cuerpos", "paisaje", "silencio", "diurnas"], emociones: ["extrañeza"] },
      { file: "02-kahlo-autoretrato.jpg", alt: "Autorretrato con chango y loro, de Frida Kahlo, colección MALBA", title: "Frida Kahlo, Autorretrato con chango y loro", autor: "Frida Kahlo", anio: 1942, tecnica: ["pintura"], motivos: ["rostro", "animales", "cuerpos", "ruido", "diurnas"], emociones: ["melancolía"]},
      ...
      { file: "08-matta-disasters.jpg", alt: "The Disasters of Mysticism, de Roberto Matta, colección MALBA", title: "Roberto Matta, The Disasters of Mysticism", autor: "Roberto Matta", anio: 1942, tecnica: ["pintura"], motivos: ["ruido", "nocturnas", "tormenta"], emociones: ["tensión"] },
      { file: "07-oiticica-metaesquema.jpg", alt: "Metaesquema, de Hélio Oiticica, colección MALBA", title: "Hélio Oiticica, Metaesquema",
        autor: "Hélio Oiticica", anio: 1958, tecnica: ["pintura"], motivos: ["silencio", "nocturnas"], emociones: ["calma"] },
      { file: "09-portinari-festa.jpg", alt: "Festa de São João, de Cândido Portinari, colección MALBA", title: "Cândido Portinari, Festa de São João", autor: "Cândido Portinari", anio: 1936, tecnica: ["pintura"], motivos: ["cuerpos", "multitud", "ruido", "diurnas"], emociones: ["contemplación", "extrañeza"] },
      { file: "04-torresgarcia-composicion.jpg", alt: "Composición simétrica universal, de Joaquín Torres García, colección MALBA", title: "Joaquín Torres García, Composición simétrica universal", autor: "Joaquín Torres García", anio: 1931, tecnica: ["pintura"], motivos: ["ruido", "diurnas"], emociones: ["extrañeza"] },
      { file: "05-solar-pareja.jpg", alt: "Pareja, de Xul Solar, colección MALBA", title: "Xul Solar, Pareja",
        autor: "Xul Solar", anio: 1923, tecnica: ["pintura"], motivos: ["cuerpos", "dualidad", "rostro", "ruido", "diurnas"], emociones: ["extrañeza"]},
      { file: "10-delavega-rompecabezas.jpg", alt: "Rompecabezas, de Jorge de la Vega, colección MALBA", title: "Jorge de la Vega, Rompecabezas", autor: "Jorge de la Vega", anio: 1969, tecnica: ["pintura"], motivos: ["cuerpos", "rostro", "ruido"], emociones: ["extrañeza"]},
      { file: "11-varo-icono1945.jpg", alt: "Ícono, de Remedios Varo, colección MALBA", title: "Remedios Varo, Ícono", autor: "Remedios Varo", anio: 1945, tecnica: ["pintura"], motivos: ["paisaje", "silencio"], emociones: ["extrañeza"]},
      ...
      { file: "14-martins-oimpossivel.jpg", alt: "O Impossivel, de María Martins, colección MALBA", title: "María Martins, O Impossivel", autor: "María Martins", anio: 1945, tecnica: ["escultura"], motivos: ["cuerpos", "dualidad", "silencio", "nocturnas"], emociones: ["extrañeza", "tensión"]},
      { file: "15-prati-composicionserial.jpg", alt: "Composición serial, de Lidy Prati, colección MALBA", title: "Lidy Prati, Composición serial", autor: "Lidy Prati", anio: 1948, tecnica: ["pintura"], motivos: ["silencio"], emociones: ["calma"]},
      { file: "16-torresgarcia-escenacallejera.jpg", alt: "Escena callejera o Calle de París o Constructivo, de Joaquín Torres García, colección MALBA", title: "Joaquín Torres García, Escena callejera o Calle de París o Constructivo", autor: "Joaquín Torres García", anio: 1930, tecnica: ["pintura"], motivos: ["cuerpos", "multitud", "paisaje urbano", "ruido", "diurnas"], emociones: ["extrañeza"] },
      { file: "17-solar-dosmestizos.jpg", alt: "Dos mestizos de avión y gente, de Xul Solar, colección MALBA", title: "Xul Solar, Dos mestizos de avión y gente", autor: "Xul Solar", anio: 1935, tecnica: ["pintura"], motivos: ["cuerpos", "dualidad", "paisaje", "multitud", "ruido", "diurnas"], emociones: ["extrañeza", "tensión"] },  
      ...
      { file: "22-oiticica-metaesquema.jpg", alt: "Metaesquema, de Hélio Oiticica, colección MALBA", title: "Hélio Oiticica, Metaesquema", autor: "Hélio Oiticica", anio: 1958, tecnica: ["pintura"], motivos: ["silencio", "nocturnas"], emociones: ["calma"] },
      { file: "23-lindner-portfolio.jpg", alt: "Portfolio de 120 dibujos, de Lux Lindner, colección MALBA", title: "Lux Lindner, Portfolio de 120 dibujos", autor: "Lux Lindner", anio: 1991, tecnica: ["dibujo"], motivos: ["cuerpos", "rostro", "silencio"], emociones: ["calma"] },
      { file: "24-schvartz-batato.jpg", alt: "Batato, de Marcia Schvartz, colección MALBA", title: "Marcia Schvartz, Batato", autor: "Marcia Schvartz", anio: 1989, tecnica: ["pintura"], motivos: ["cuerpos", "rostro", "silencio", "diurnas"], emociones: ["tensión", "contemplación", "melancolía"] },
      { file: "25-deira-nuevevariaciones.jpg", alt: "Nueve variaciones para un bastidor bien tensado, de Ernesto Deira, colección MALBA", title: "Ernesto Deira, Nueve variaciones para un bastidor bien tensado", autor: "Ernesto Deira", anio: 1965, tecnica: ["pintura"], motivos: ["cuerpos", "rostro", "ruido"], emociones: ["confusión", "tensión"] },
      { file: "26-heinrich-lamano.jpg", alt: "La mano, de Annemarie Heinrich, colección MALBA", title: "Annemarie Heinrich, La mano", autor: "Annemarie Heinrich", anio: 1953, tecnica: ["fotografía"], motivos: ["cuerpos", "rostro", "silencio", "nocturnas"], emociones: ["confusión", "extrañeza"] },
  ...
  amalita: {
    ...
    images: [
      { file: "01-noe-tormenta.jpg", alt: "Tormenta en la Pampa. Homenaje a una pintura escrita por Sarmiento, de Luis Felipe Noé, colección Amalita", title: "Luis Felipe Noé, Tormenta en la Pampa. Homenaje a una pintura escrita por Sarmiento",
        autor: "Luis Felipe Noé", anio: 1991, tecnica: ["pintura"], motivos: ["paisaje", "tormenta", "ruido", "nocturnas"], emociones: ["contemplación"]},
      { file: "02-malharro-crepusculo.jpg", alt: "Crespúsculo, de Martín Malharro, colección Amalita", title: "Martín Malharro, Crespúsculo",
        autor: "Martín Malharro", anio: 1901, tecnica: ["pintura"], motivos: ["paisaje", "árboles", "silencio", "diurnas"], emociones: ["contemplación"]},
      ...
      { file: "05-fader-tropilla.jpg", alt: "La tropilla, de Fernando Fader, colección Amalita", title: "Fernando Fader, La tropilla",
        autor: "Fernando Fader", anio: 1907, tecnica: ["pintura"], motivos: ["paisaje", "animales", "cielo", "ruido", "diurnas"], emociones: ["contemplación"]},
      ...
      { file: "08-alonso-invierno.jpg", alt: "Fin del Invierno, de Carlos Alonso, colección Amalita", title: "Carlos Alonso, Fin del Invierno", autor: "Carlos Alonso", anio: 1974, tecnica: ["pintura"], motivos: ["paisaje", "silencio", "diurnas"], emociones: ["extrañeza", "contemplación"]},
      ...
      { file: "10-benedit-tijera.jpg", alt: "Caja de Campo - Tijera de castrar, de Luis Fernando Benedit, colección Amalita", title: "Luis Fernando Benedit, Caja de Campo - Tijera de castrar", autor: "Luis Fernando Benedit", anio: 1978, tecnica: ["escultura"], motivos: ["objetos", "silencio", "diurnas"], emociones: ["extrañeza"]},
      { file: "11-berni-almuerzo.jpg", alt: "Domingo en la chacra o El almuerzo, de Antonio Berni, colección Amalita", title: "Antonio Berni, Domingo en la chacra o El almuerzo", autor: "Antonio Berni", anio: 1945, tecnica: ["pintura"], motivos: ["multitud", "rostro", "paisaje", "cuerpos", "ruido", "diurnas"], emociones: ["contemplación", "extrañeza"]},  
      ...
      { file: "13-fader-duraznos.jpg", alt: "Entre duraznos floridos, de Fernando Fader, colección Amalita", title: "Fernando Fader, Entre duraznos floridos", autor: "Fernando Fader", anio: 1915, tecnica: ["pintura"], motivos: ["paisaje", "árboles", "cuerpos", "silencio", "diurnas"], emociones: ["calma", "melancolía"]},
      { file: "14-solar-bripaisgente.jpg", alt: "Bri-País-Gente, de Xul Solar, colección Amalita", title: "Xul Solar, Bri-País-Gente", autor: "Xul Solar", anio: 1933, tecnica: ["pintura"], motivos: ["paisaje urbano", "multitud", "cuerpos", "ruido", "nocturnas"], emociones: ["calma", "melancolía", "extrañeza"]},
      { file: "15-solar-noche.jpg", alt: "Noche, de Xul Solar, colección Amalita", title: "Xul Solar, Noche", autor: "Xul Solar", anio: 1933, tecnica: ["pintura"], motivos: ["paisaje urbano", "multitud", "cuerpos", "ruido", "nocturnas"], emociones: ["calma", "melancolía", "extrañeza"]},
      { file: "16-solar-zigzag.jpg", alt: "Zig-zag, de Xul Solar, colección Amalita", title: "Xul Solar, Zig-zag", autor: "Xul Solar", anio: 1949, tecnica: ["pintura"], motivos: ["paisaje urbano", "multitud", "cuerpos"], emociones: ["calma", "melancolía", "extrañeza"]},
      { file: "17-solar-cupulas.jpg", alt: "Cúpulas, de Xul Solar, colección Amalita", title: "Xul Solar, Cúpulas", autor: "Xul Solar", anio: 1948, tecnica: ["pintura"], motivos: ["paisaje urbano", "multitud", "cuerpos", "ruido", "diurnas"], emociones: ["calma", "melancolía", "extrañeza"]},
      { file: "18-solar-pantree.jpg", alt: "Pan-tree, de Xul Solar, colección Amalita", title: "Xul Solar, Pan-tree", autor: "Xul Solar", anio: 1954, tecnica: ["pintura"], motivos: [], emociones: ["extrañeza"]},
      { file: "19-solar-pantree2.jpg", alt: "Pan-tree, de Xul Solar, colección Amalita", title: "Xul Solar, Pan-tree", autor: "Xul Solar", anio: 1953, tecnica: ["pintura"], motivos: [], emociones: ["extrañeza"]},
      { file: "20-solar-horoscopomml.jpg", alt: "Horóscopo de Manuel Mujica Láinez, de Xul Solar, colección Amalita", title: "Xul Solar, Horóscopo de Manuel Mujica Láinez", autor: "Xul Solar", anio: 1953, tecnica: ["pintura"], motivos: [], emociones: ["extrañeza"]},
